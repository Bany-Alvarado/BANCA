...
<body>
    ...
    <section class="hero-area">
        <form action="<?php echo "validar.php?tipo=".$_GET['id'] ?> " method="POST">
            <div class="container">
                <label for="cta"><b>No. Cuenta</b></label>
                <input type="text" placeholder="No. Cuenta" name="cta" required>

                <button type="submit" name="btn_Save">Consultar</button>
            </div>
        </form>
