...
<body>
    ...
    <section class="hero-area">
        <form>
            ...
            $result2 = $mysqli->query("SELECT  SALDO FROM CUENTA  where ID = '".$_GET['id']. "'");
                ...
                if ($result2->num_rows > 0) {
                    while($s = $result2->fetch_assoc()) {
                        echo "<h2> SALDO TOTAL:".$s['SALDO']."</h2>";
                    }
                }
            ...
            echo "<thead>
                <tr>
                <th class=\"table__heading\">COMENTARIO</th>
                <th class=\"table__heading\">MONTO DEBITADO</th>
                </tr>
            </thead>";
            echo " <tbody>";
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class=\"table__content\">".$row['COMENTARIO']."</td>";
                    echo "<td class=\"table__content\">".$row['MONTO']."</td>";
                    echo "</tr>";
                }
            }
            echo "</tbody>";
